...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.misc.ragdolls, 0, crypt_str("Misc.ragdolls"));
	...
	setup_item(&g_cfg.misc.walkbot_key, key_bind(HOLD), crypt_str("Misc.walkbot_key"));
	...
	setup_item(&g_cfg.misc.walkbot, 4, crypt_str("Misc.walkbot"));
