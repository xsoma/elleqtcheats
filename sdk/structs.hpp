...
public:
    ...
    NETVAR(byte, m_bUseCustomBloomScale, crypt_str("CEnvTonemapController"), crypt_str("m_bUseCustomBloomScale"));
    NETVAR(float, m_flCustomBloomScale, crypt_str("CEnvTonemapController"), crypt_str("m_flCustomBloomScale"));
    NETVAR(byte, m_bUseCustomAutoExposureMin, crypt_str("CEnvTonemapController"), crypt_str("m_bUseCustomAutoExposureMin"));
    NETVAR(float, m_flCustomAutoExposureMin, crypt_str("CEnvTonemapController"), crypt_str("m_flCustomAutoExposureMin"));
    NETVAR(byte, m_bUseCustomAutoExposureMax, crypt_str("CEnvTonemapController"), crypt_str("m_bUseCustomAutoExposureMax"));
    NETVAR(float, m_flCustomAutoExposureMax, crypt_str("CEnvTonemapController"), crypt_str("m_flCustomAutoExposureMax"));
    ...
    Vector GetPropVector(std::string& table, std::string& var)
    {
        static auto offset = netvars::get().get_offset(table.c_str(), var.c_str());
        Vector val = *(Vector*)(uintptr_t(this) + (int)offset);
        return val;
    }
    ...
    {
        *reinterpret_cast<bool*>(uintptr_t(this) + (int)netvars::get().get_offset(table.c_str(), var.c_str())) = val;
    }
    void SetPropVector(std::string& table, std::string& var, Vector val)
    {
        *reinterpret_cast<Vector*>(uintptr_t(this) + (int)netvars::get().get_offset(table.c_str(), var.c_str())) = val;
    }
