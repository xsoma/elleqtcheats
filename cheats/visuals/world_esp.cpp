...
void worldesp::world_modulation(entity_t* entity)
{
	...
	entity->m_flCustomBloomScale() = g_cfg.esp.bloom * 0.01f;

	entity->m_bUseCustomAutoExposureMin() = TRUE;
	entity->m_flCustomAutoExposureMin() = g_cfg.esp.exposure * 0.001f;

	entity->m_bUseCustomAutoExposureMax() = TRUE;
	entity->m_flCustomAutoExposureMax() = g_cfg.esp.exposure * 0.001f;
}
...
void worldesp::grenade_projectiles(entity_t* entity)
{
		...
		client_class->m_ClassID == CBaseCSGrenadeProjectile || client_class->m_ClassID == CDecoyProjectile || client_class->m_ClassID == CMolotovProjectile)
	{
		...
		if (!strcmp(name, "flashbang"))
		{
			grenade_name = "FLASHBANG";
			grenade_icon = "i";
		}
		else if (!strcmp(name, "smokegrenade"))
		{
			grenade_name = "SMOKE";
			grenade_icon = "k";
		}
		else if (!strcmp(name, "incendiarygrenade"))
		{
			grenade_name = "INCENDIARY";
			grenade_icon = "n";
		}
		else if (!strcmp(name, "molotov"))
		{
			grenade_name = "MOLOTOV";
			grenade_icon = "l";
		}
		else if (!strcmp(name, "fraggrenade"))
		{
			grenade_name = "HE GRENADE";
			grenade_icon = "j";
		}
		else if (!strcmp(name, "decoy"))
		{
			grenade_name = "DECOY";
			grenade_icon = "m";
		}
