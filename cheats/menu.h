...
private:
	...
	int default_section = 0;

	float tabs_width, tabs_height = 0.f;
	float footer_width, footer_height = 0.f;
	float category_width, category_height = 0.f;
	float content_width, content_height = 0.f;
