...
namespace hooks
{
	...
	extern vmthook* enginevgui_hook;
	extern vmthook* soundservice_hook;
	...
	void __stdcall hooked_enginevgui(int mode);
	...
	void __stdcall hooked_onsoundstart(void* pEcx, void* pEdx, int32_t iGuid, StartSoundParams_t* pParams, const char* kchpSoundname);
